...
import { ComentariosProductoComponent } from 'app/entities/comentarios-producto/comentarios-producto.component';
...
describe('Component Tests', () => {
  describe('ComentariosProducto Management Component', () => {
    let comp: ComentariosProductoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ComentariosProductoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new ComentariosProducto(123)],
            headers
          })
        )
      );
      ...
      expect(comp.comentariosProductos && comp.comentariosProductos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

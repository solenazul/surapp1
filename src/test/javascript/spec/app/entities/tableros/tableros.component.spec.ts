...
import { TablerosComponent } from 'app/entities/tableros/tableros.component';
...
describe('Component Tests', () => {
  describe('Tableros Management Component', () => {
    let comp: TablerosComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TablerosComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.tableros && comp.tableros[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

...
import { IPSComponent } from 'app/entities/ips/ips.component';
import { IPSService } from 'app/entities/ips/ips.service';
import { IPS } from 'app/shared/model/ips.model';

describe('Component Tests', () => {
  describe('IPS Management Component', () => {
    let comp: IPSComponent;
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.iPS && comp.iPS[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

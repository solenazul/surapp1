...
import { HistorialOfertasComponent } from 'app/entities/historial-ofertas/historial-ofertas.component';
...
describe('Component Tests', () => {
  describe('HistorialOfertas Management Component', () => {
    let comp: HistorialOfertasComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(HistorialOfertasComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.historialOfertas && comp.historialOfertas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

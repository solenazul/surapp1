...
import { ServiciosComponent } from 'app/entities/servicios/servicios.component';
...
describe('Component Tests', () => {
  describe('Servicios Management Component', () => {
    let comp: ServiciosComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ServiciosComponent, '')
        .compileComponents();

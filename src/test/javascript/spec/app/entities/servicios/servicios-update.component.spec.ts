...
import { ServiciosUpdateComponent } from 'app/entities/servicios/servicios-update.component';
  ...
  describe('Servicios Management Update Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [ServiciosUpdateComponent],
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', fakeAsync(() => {
        // GIVEN
        const entity = new Servicios(123);

...
import { CategoriaProductoComponent } from 'app/entities/categoria-producto/categoria-producto.component';
  ...
  describe('CategoriaProducto Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new CategoriaProducto(123)],
            headers
          })
        )
      );
      ...
      expect(comp.categoriaProductos && comp.categoriaProductos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

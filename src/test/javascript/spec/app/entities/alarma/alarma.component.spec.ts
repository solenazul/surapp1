...
import { AlarmaComponent } from 'app/entities/alarma/alarma.component';
import { AlarmaService } from 'app/entities/alarma/alarma.service';
import { Alarma } from 'app/shared/model/alarma.model';

describe('Component Tests', () => {
  describe('Alarma Management Component', () => {
    let comp: AlarmaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AlarmaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.alarmas && comp.alarmas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

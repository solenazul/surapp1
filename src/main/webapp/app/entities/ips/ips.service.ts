...
type EntityResponseType = HttpResponse<IIPS>;
type EntityArrayResponseType = HttpResponse<IIPS[]>;

@Injectable({ providedIn: 'root' })
export class IPSService {
  public resourceUrl = SERVER_API_URL + 'api/ips';
  ...
  update(iPS: IIPS): Observable<EntityResponseType> {
    return this.http.put<IIPS>(this.resourceUrl, iPS, { observe: 'response' });
  }

...
/**
 * Criteria class for the {@link com.be4tech.surap.domain.FavoritosServicios} entity. This class is used
 * in {@link com.be4tech.surap.web.rest.FavoritosServiciosResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /favoritos-servicios?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class FavoritosServiciosCriteria implements Serializable, Criteria {
    ...
    public FavoritosServiciosCriteria() {
    }

    public FavoritosServiciosCriteria(FavoritosServiciosCriteria other) {
    ...
    @Override
    public FavoritosServiciosCriteria copy() {
        return new FavoritosServiciosCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final FavoritosServiciosCriteria that = (FavoritosServiciosCriteria) o;
        return
    ...
    public String toString() {
        return "FavoritosServiciosCriteria{" +
                (id != null ? "id=" + id + ", " : "") +

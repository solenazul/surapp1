...
/**
 * Criteria class for the {@link com.be4tech.surap.domain.ComentariosProducto} entity. This class is used
 * in {@link com.be4tech.surap.web.rest.ComentariosProductoResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /comentarios-productos?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ComentariosProductoCriteria implements Serializable, Criteria {
    ...
    public ComentariosProductoCriteria() {
    }

    public ComentariosProductoCriteria(ComentariosProductoCriteria other) {
    ...
    @Override
    public ComentariosProductoCriteria copy() {
        return new ComentariosProductoCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ComentariosProductoCriteria that = (ComentariosProductoCriteria) o;
        return
    ...
    public String toString() {
        return "ComentariosProductoCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
